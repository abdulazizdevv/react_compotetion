    ...
    <footer className="footer">
      <div className="container footer_container">
        <div className="footer_item">
          ...
          <p className="footer_item_title sub">Subscribe</p>
          <p className="footer_item_title sale">Get 10% off your first order</p>
        ...
        <div className="footer_item">
          <h3 className="footer_item_title titleDesc">Support</h3>
          <a
            className="footer_item_link"
            href="https://goo.gl/maps/5EZRWDJjdsThHnr36"
          >
            111 Bijoy sarani, Dhaka, DH 1515, Bangladesh.
          </a>
          <a className="footer_item_link" href="mailto:exclusive@gmail.com">
            exclusive@gmail.com
          </a>
          <a className="footer_item_link" href="tel:+88015-88888-9999">
            +88015-88888-9999
          </a>
        </div>
        <div className="footer_item third">
          <h3 className="footer_item_title titleDesc">Account</h3>
          <Link to="/account" className="footer_item_link">
            My Account
          </Link>
          <div className="log_reg">
            <Link to="/login" className="footer_item_link">
              Login
            </Link>
            <span>/</span>
            <Link to="/register" className="footer_item_link">
              Register
            </Link>
          </div>
          <Link to="/cartPage" className="footer_item_link">
            Cart
          </Link>
          <Link to="/wishlist" className="footer_item_link">
            Wishlist
          </Link>
          <Link to="/product" className="footer_item_link">
            Shop
          </Link>
        </div>
        <div className="footer_item fourth">
          <h3 className="footer_item_title titleDesc">Quick Link</h3>
          <Link to="/" className="footer_item_link">
            Privacy Policy
          </Link>
          <Link to="/" className="footer_item_link">
            Terms Of Use
          ...
          <Link to="/contact" className="footer_item_link">
            Contact
          </Link>
        </div>
        <div className="footer_item">
          <h3 className="footer_item_title titleDesc">Download App</h3>
          <p className="saving">Save $3 with App New User Only</p>
          <div className="Downlolad">
            <div>
              <img src={qrCode} />
            </div>
          ...
          <div className="socialmedia">
            ...
            <Link to="/">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_939_1167)">
                  <path
